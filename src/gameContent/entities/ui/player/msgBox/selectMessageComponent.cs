...
class SelectMessageComponent : Component {
    const int SCALE = 6;
    Renderer renderer;
    bool shouldDraw;
    Texture2D texture;
    ...
    public SelectMessageComponent(Game game, Entity _parent) : base(_parent) {
    ...
    public override void Draw() {
        if (shouldDraw) {
            ...
            if (icon1 is not null) {
                ...
                renderer.DrawTo(LayerType.UI, texture, new Vector2(xx, yy), icon1.data.frames[0], Color.White, 0, icon1.data.origin, new Vector2(2, 2), SpriteEffects.None, 0.5f);
            ...
            if (icon2 is not null) {
                ...
                renderer.DrawTo(LayerType.UI, texture, new Vector2(xx, yy), icon2.data.frames[0], Color.White, 0, icon2.data.origin, new Vector2(2, 2), SpriteEffects.None, 0.5f);
            ...
            if (icon3 is not null) {
                ...
                renderer.DrawTo(LayerType.UI, texture, new Vector2(xx, yy), icon3.data.frames[0], Color.White, 0, icon3.data.origin, new Vector2(2, 2), SpriteEffects.None, 0.5f);
            ...
            if (icon4 is not null) {
                ...
                renderer.DrawTo(LayerType.UI, texture, new Vector2(xx, yy), icon4.data.frames[0], Color.White, 0, icon4.data.origin, new Vector2(2, 2), SpriteEffects.None, 0.5f);

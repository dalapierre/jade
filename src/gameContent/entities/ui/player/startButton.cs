...
class StartButton : Entity {
    ...
    public StartButton(Game _game, Keys _key) : base(_game) {
        SetScale(6);
        SetSprite("start_btn", LayerType.UI);
        ...
        hover.SetMessage("Start", "Once you have unit queued press ENTER", "to start the attack");
